...
# https://github.com/aiortc/aiortc/blob/1.0.0/examples/server/server.py#L65C2-L65C2
# https://dev.to/whitphx/python-webrtc-basics-with-aiortc-48id
# https://github.com/aiortc/aiortc/blob/main/examples/datachannel-cli/cli.py

# This is the code that sends webcam stream
